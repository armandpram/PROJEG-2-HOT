...
<html>
    ...
    <%
        ...
        String peminatan=request.getParameter("cbpeminatan");
        ...
        if(dapat.toString().equals("cmdsimpan"))
        {
            try
            {
                ...
                String sql="insert into calas19 (NIM, NAMA, JK, PEMINATAN, ALAMAT, AGAMA, EMAIL) values ('"+nim+"', '"+nama+"', '"+jk+"', '"+peminatan+"', '"+alamat+"', '"+agama+"', '"+email+"')";
                st.executeUpdate(sql);
                conn.close();
                out.print("Berhasil disimpan");
                out.print("<a href='index.jsp'>Balik</a>");
            }
            catch(Exception e)
            {
                out.print(e);
        ...
        else if(dapat.toString().equals("ubah"))
        {
            try
            {
                ...
                Connection conn=konek.bukaKoneksi();
                Statement st=conn.createStatement();
                String sqll="update calas19 set nama='"+nama+"', alamat='"+alamat+"', '"+peminatan+"' "+"where nim='"+nim+"'";
